...
## Classification of LEGv8 Instruction based on Instruction Format - Register Type
...
- `Rn` and `Rm`: Specify the first and second source registers
...
The instruction is now a single binary string `10001011000 10101 000000 10100 01001` = `0x8B150289`

1. ALU checks opcode (1001011000) and performs operation
2. Read address 1 (10101)
3. Read address 2 (10100)
4. Add them together
5. store in Rd (01001)
...
- The read data is saved in the destination register
