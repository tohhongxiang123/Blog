...
2. Algorithm 1 does not support progress
    - If P0 were to finish running its critical section, but crash within its exit section before updating the turn, other processes will never get their turn
