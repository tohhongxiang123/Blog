...
For example, from the relations Product(name, price, company) and Company(name, city),

1. Find all companies that make **some** products with price < 100
...
2. Find all companies that make products **all** having price < 100
