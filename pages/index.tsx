                ...
                <div className="flex items-start flex-col gap-8 w-full mx-auto max-w-3xl">
                    ...
                    <ul className="flex flex-col gap-y-8">
                        ...
                        >
                            ...
                            <ul className="list-disc list-inside flex flex-col gap-y-2">
                                <motion.li variants={experienceItemVariants}>
                                    Designed and implemented new features to for
                                    an e-commerce web application to track and
                                    trade warehouse stocks
                                </motion.li>
                                <motion.li variants={experienceItemVariants}>
                                    Developed a Drag-and-Drop template builder
                                    for websites
                                </motion.li>
                                <motion.li variants={experienceItemVariants}>
                                    Implemented smooth UI/UX, delivering
                                    consistent results ahead of schedule
                                </motion.li>
                                <motion.li variants={experienceItemVariants}>
                                    Demonstrated high levels of initiative by
                                    spotting potential bugs ahead of time,
                        ...
                        >
                            <div>
                                ...
                                <motion.p
                                    ...
                                    className="font-medium text-lg text-gray-600 mb-4"
                                >
                                    An E-Commerce Website built with NextJS and
                                    Directus as a CMS
                                </motion.p>
                                <ul className="list-disc list-inside flex flex-col gap-y-2 mb-4">
                                    ...
                                    <motion.li variants={projectItemVariants}>
                                        Snipcart integration for payments and
                                ...
                                <div className="flex mb-4 gap-x-4">
                                    ...
                                    <motion.a
                                        variants={projectItemVariants}
                                        href="https://shopping.seshuri.com/"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    >
                                        <motion.img
                        ...
                        >
                            <div>
                                ...
                                <div className="flex mb-4 gap-x-4">
                                    ...
                                    <motion.a
                                        variants={projectItemVariants}
                                        href="https://gallereddit.herokuapp.com/"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    >
                                        <motion.img
                        ...
                        >
                            <div>
                                ...
                                <div className="flex mb-4 gap-x-4">
                                    ...
                                    <motion.a
                                        variants={projectItemVariants}
                                        href="https://singapore-air-quality.herokuapp.com/"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    >
                                        <motion.img
