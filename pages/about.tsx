            ...
            <div className="p-4">
                <section className="flex flex-col justify-center items-center sm:px-8 md:px-16 py-16">
                    ...
                    <p className="max-w-2xl font-semibold opacity-60 text-md sm:text-lg mb-8 text-justify">
                        Located in Singapore, I am a full-stack web developer
                        who specializes in React. I am committed to high
                        standards of web design, and I am always learning to
                        expand my ever-growing skillset. Currently looking for
                        an internship to work at between May - Dec 2022
                    </p>
