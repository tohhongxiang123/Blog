		...
		<Layout title="About" description="All about Toh Hong Xiang">
			<div className="p-4">
				<section className="flex flex-col justify-center items-center sm:px-8 md:px-16 py-16">
					...
					<p className="max-w-2xl font-semibold opacity-60 text-md sm:text-lg mb-8 text-justify">
						An experienced Full-Stack Web Developer seeking
						challenging roles to deliver impactful, high-value
						experiences to the world. Equipped with a strong passion
						for learning, and extremely self-motivated, with proven
						abilities to tackle complex software engineering
						challenges and deliver innovative solutions while
				...
				<section
					className="flex flex-col justify-center items-center max-w-7xl mx-auto sm:p-8 md:p-16"
					id="projects"
				>
					<h2 className="text-5xl font-bold tracking-wide mb-12">
						Projects
					</h2>
				...
				<section className="flex flex-col justify-center items-center sm:px-8 md:px-16 py-16 max-w-4xl mx-auto">
					...
					<ul className="flex flex-wrap gap-8 justify-center items-center">
						...
						<li>
							<ImageWithLabel src="/icons/css3.svg" label="CSS" />
						</li>
						<li>
							<ImageWithLabel
						...
						<li>
							<ImageWithLabel src="/icons/vue.svg" label="Vue" />
						</li>
						<li>
							<ImageWithLabel
				...
				<section
					className="flex flex-col justify-center items-center sm:px-8 md:px-16 py-16 max-w-7xl mx-auto"
					id="projects"
				>
					<h2 className="text-5xl font-bold tracking-wide mb-12">
						Contact Me!
